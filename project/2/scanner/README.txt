...
---- 1. To install it, if you have pip, just do 'pip install ply' on the terminal
---- 2. if you don't have pip, download get-pip.py from https://pip.pypa.io/en/stable/installing/ and run 'get-pip.py'. This will install pip and then go to step 1.
